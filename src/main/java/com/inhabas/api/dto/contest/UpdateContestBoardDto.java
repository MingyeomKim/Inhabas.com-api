...
public class UpdateContestBoardDto extends UpdateBoardDto {
    ...
    public UpdateContestBoardDto(Integer id, String title, String contents, String association, String topic, LocalDate start, LocalDate deadline) {
